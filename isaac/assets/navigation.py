...
def height_scan(env: ManagerBasedEnv, sensor_cfg: SceneEntityCfg, offset: float = 0.5) -> torch.Tensor:
    ...
    out_features = sensor.data.pos_w[:, 2].unsqueeze(1) - sensor.data.ray_hits_w[..., 2] - offset
    # print(torch.mean(out_features, dim=-1).unsqueeze(0))
    return torch.mean(out_features, dim=-1).unsqueeze(0)