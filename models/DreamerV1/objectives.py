...
class DreamerModelLoss(LossModule):
    ...
    def forward(self, tensordict: TensorDict) -> torch.Tensor:
        ...
        reward_dist = torchrl.modules.IndependentNormal(
            loc=tensordict.get(("next", self.tensor_keys.reward)),
            scale=1,
            event_dim=1,
        )
