...
def make_model(
    ...
    world_model_loss = DreamerModelLoss(
        ...
        optimizer_kwargs={"lr": cfg.optimization.world_model_lr},
    ...
    actor_loss = DreamerActorLoss(
        ...
        optimizer_cls=torch.optim.Adam,
        optimizer_kwargs={"lr": cfg.optimization.actor_lr},
        use_grad_scaler=cfg.optimization.use_autocast
    )
    ...
    value_loss = DreamerValueLoss(
        ...
        optimizer_cls=torch.optim.Adam,
        optimizer_kwargs={"lr": cfg.optimization.value_lr},
        use_grad_scaler=cfg.optimization.use_autocast
    )
    ...
    return losses, policy, model_based_env_eval, lambda x: x
