...
class DreamerV2:
    ...
    def _init_networks(self, config, proof_env):
        ...
        return nn.ModuleDict(modules = dict(
                ...
                velocity_encoder = MLP(out_features=32, depth=1, num_cells=32, activation_class=activation),
                veolcity_decoder = MLP(out_features=6, depth=1, num_cells=32, activation_class=activation),
                command_encoder = MLP(out_features=32, depth=1, num_cells=32, activation_class=activation),
                command_decoder = MLP(out_features=4, depth=1, num_cells=32, activation_class=activation),
                joint_encoder = MLP(out_features=1024, depth=1, num_cells=32, activation_class=activation),
